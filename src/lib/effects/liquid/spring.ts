...
export function resolveTransition(t: Transition | undefined, reducedMotion = false): ResolvedTransition {
	...
	const spring: Required<SpringConfig> =
		typeof cfg === 'string' ? presets[cfg] : { stiffness: 300, damping: 24, mass: 1, ...cfg }
