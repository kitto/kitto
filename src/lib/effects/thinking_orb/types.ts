...
import type { ModeOpts } from './engine/profiles.js'
import type { ModeFrame } from './engine/types.js'
import type { GravityOptions } from './gravity.js'
...
/** Props for the ThinkingOrb component. Every other `<canvas>` attribute passes through. */
export interface ThinkingOrbProps extends Omit<HTMLCanvasAttributes, 'children'> {
