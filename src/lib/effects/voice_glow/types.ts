 ...
 */
export type VoiceBeamColorVariant = 'colorful' | 'mono' | 'ocean' | 'sunset' | 'forest' | 'candy' | 'ice' | 'gold'
 ...
 */
export interface VoiceBeamProps extends Omit<HTMLAttributes<HTMLDivElement>, 'children' | 'class' | 'style'> {
	 ...
	 * Handy for a meter or a "listening" label; avoid setting reactive state
