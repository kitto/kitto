 ...
 */
import { GLOW_READBACK_INTERVAL_MS } from '../perf_config.js'
import { SHARED, CANONICAL_PILL_W, CANONICAL_PILL_H, type MetalFxInstance, type ShaderRGB } from './core.js'
 ...
 *  read as lit. */
export function sampleShaderPeakAt(
	inst: MetalFxInstance,
	cssPxX: number,
	cssPxY: number,
	radius: number
